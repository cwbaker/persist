...
begin_element . contents end_element ; dot_end, right_curly_brace_terminal, comma_terminal
. name eq_terminal left_curly_brace_terminal ; name
...
shift to 15 on element ; 
shift to 3 on begin_element ; 
shift to 5 on contents ; 
shift to 14 on content ; 
shift to 16 on attribute ; 
shift to 8 on name ; 
...
5:
begin_element contents . end_element ; dot_end, right_curly_brace_terminal, comma_terminal
. right_curly_brace_terminal ; dot_end, right_curly_brace_terminal, comma_terminal
contents . comma_terminal content ; right_curly_brace_terminal, comma_terminal
shift to 6 on end_element ; 
shift to 12 on right_curly_brace_terminal ; 
shift to 4 on comma_terminal ; 
...
9:
name eq_terminal . left_curly_brace_terminal ; name
shift to 11 on left_curly_brace_terminal ; 
...
shift to 11 on left_curly_brace_terminal ; 
shift to 18 on boolean ; 
shift to 17 on nil ; 
shift to 22 on true_terminal ; 
shift to 23 on false_terminal ; 
shift to 19 on integer ; 
shift to 20 on real ; 
shift to 21 on string ; 
...
const sweet::parser::ParserState lua_parser_state_22 =
{
    ...
    lua_parser_state_22_transitions + 2
};
...
const sweet::parser::ParserState lua_parser_state_23 =
{
    ...
    lua_parser_state_23_transitions + 2
};
