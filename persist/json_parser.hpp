...
shift to 5 on begin_element ; 
shift to 9 on string ; 
...
. string colon_terminal null ; right_curly_brace_terminal, comma_terminal
. string colon_terminal boolean ; right_curly_brace_terminal, comma_terminal
. string colon_terminal integer ; right_curly_brace_terminal, comma_terminal
. string colon_terminal real ; right_curly_brace_terminal, comma_terminal
. string colon_terminal string ; right_curly_brace_terminal, comma_terminal
shift to 17 on element ; 
shift to 5 on begin_element ; 
shift to 7 on contents ; 
shift to 16 on content ; 
shift to 18 on attribute ; 
shift to 10 on string ; 
...
7:
begin_element contents . end_element ; right_curly_brace_terminal, comma_terminal
. right_curly_brace_terminal ; right_curly_brace_terminal, comma_terminal
contents . comma_terminal content ; right_curly_brace_terminal, comma_terminal
shift to 14 on right_curly_brace_terminal ; 
shift to 8 on end_element ; 
...
const sweet::parser::ParserState json_parser_state_8 =
{
    ...
    json_parser_state_8_transitions + 2
};

/*
9:
string . colon_terminal left_curly_brace_terminal ; string
shift to 11 on colon_terminal ; 
...
11:
string colon_terminal . left_curly_brace_terminal ; string
shift to 13 on left_curly_brace_terminal ; 
...
shift to 13 on left_curly_brace_terminal ; 
shift to 20 on boolean ; 
shift to 23 on string ; 
shift to 19 on null ; 
shift to 24 on true_terminal ; 
shift to 25 on false_terminal ; 
shift to 21 on integer ; 
shift to 22 on real ; 
...
const sweet::parser::ParserState json_parser_state_25 =
{
    ...
    json_parser_state_25_transitions + 2
};
