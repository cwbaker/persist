...
{
    typedef sweet::parser::ParserNode<UserData, Char, Traits, Allocator> ParserNode;
    typedef sweet::parser::ParserEventSink<Iterator, UserData, Char, Traits, Allocator> ParserEventSink;
